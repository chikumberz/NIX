		...
		<section class = "panel primary">
			...
			<section class = "panel-body clearfix">
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_station_id' ) }}</b></label>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_station_equipment_id' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
				...
				<section class = "panel default">
					...
					<section class = "panel-body clearfix" id = "display-fetch">
						{% for parameter in var_station_equipment_measurement_parameters %}
						<div class = "control-group column-group validation">
							<label for = "{{ value_id }}" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ parameter.getEquipmentMeasurementParameter( ).parameter }}</b></label>
							<div class = "control medium-100 small-100 tiny-100 all-80">
								{{ parameter.value }}
							</div>
						</div>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_file' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ file }}
					</div>
				</div>
