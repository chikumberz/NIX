			...
			<section class = "panel primary">
				...
				<section class = "panel-body">
					...
					<div class = "control-group column-group validation">
						...
						<div class = "control medium-100 small-100 tiny-100 all-80">
							{{ select( 'station_equipment_id', var_equipments, 'using' : ['station_equipment_id', 'name'], 'useEmpty' : true, 'emptyText' : _._( 'placeholder_station_equipment_id' ), 'class' : 'fetch-content-parameter', 'id' : 'display-content-equipment' ) }}
					...
					<section class = "panel default">
						...
						<section class = "panel-body clearfix" id = "display-fetch-parameter">
							...
							<div class = "control-group column-group validation">
								<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ parameter.getEquipmentMeasurementParameter( ).parameter }}</b></label>
								<div class = "control medium-100 small-100 tiny-100 all-80">
									{{ text_field( 'value' ~ '[' ~ parameter.getEquipmentMeasurementParameter( ).getId( ) ~ ']' ) }}
								</div>
							</div>
							{% endFor %}
						</section>
