							...
							<li>
								<div class = "ink-dropdown red" data-target = "#grid-action-menu" id = "grid-action">
									...
									<ul id = "grid-action-menu" class = "dropdown-menu hide-all no-margin unstyled">
										...
										<li class = "separator-above"></li>
										<li><a href = "{{ url.get( ['for' : 'admin-action', 'folder' : 'station', 'controller' : var_controller, 'action' : 'add'] ) }}"><i class = "fa fa-download quarter-right-space"></i> {{ _._( 'btn_add' ) }}</a></li>
										<li class = "separator-above"></li>
										<li><a href = "{{ url.get( ['for' : 'admin-action', 'folder' : 'station', 'controller' : var_controller, 'action' : 'print'] ) }}"><i class = "fa fa-print quarter-right-space"></i> {{ _._( 'btn_print' ) }}</a></li>
									</ul>
								</div>
							</li>
						</ul>
										...
										<ul id = "actions-{{ row.getId( ) }}" class = "dropdown-menu hide-all no-margin unstyled">
											<?php if ( property_exists( $row, 'is_archived' ) ) { ?>
												<?php if ( $row->is_archived ) { ?>
													<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'unarchive', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-folder-open quarter-right-space"></i>{{ _._( 'btn_unarchive'  ) }}</a></li>
												<?php } else { ?>
													<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'view', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-file-text quarter-right-space"></i>{{ _._( 'btn_view'  ) }}</a></li>
													<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'edit', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-pencil quarter-right-space"></i>{{ _._( 'btn_edit'  ) }}</a></li>
													<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'archive', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-archive quarter-right-space"></i>{{ _._( 'btn_archive'  ) }}</a></li>
													<li class = "active"><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'delete', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-trash-o quarter-right-space"></i>{{ _._( 'btn_delete'  ) }}</a></li>
												<?php } ?>
											<?php } else { ?>
												<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'view', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-file-text quarter-right-space"></i>{{ _._( 'btn_view'  ) }}</a></li>
												<li><a href = "<?php echo $this->url->get( array( 'for' => 'admin-full', 'folder' => 'station', 'controller' => $var_controller, 'action' => 'edit', 'params' => $row->getId( ) ) ); ?>"><i class = "fa fa-pencil quarter-right-space"></i>{{ _._( 'btn_edit'  ) }}</a></li>
