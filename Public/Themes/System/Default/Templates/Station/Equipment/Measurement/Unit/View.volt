		...
		<section class = "panel primary">
			...
			<section class = "panel-body clearfix">
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_unit' ) }}</b></label>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_value' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ value }}
					</div>
				</div>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_symbol_left' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ symbol_left }}
					</div>
				</div>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_symbol_right' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ symbol_right }}
					</div>
				</div>
