<form action = "{{ var_form_url }}" method = "post" enctype = "multipart/form-data" class = "ink-form clearfix">
		...
		<div class = "all-70 large-100 medium-100 small-100 tiny-100">
			<section class = "panel primary">
				...
				<section class = "panel-body">
					...
					<h4 class = "title-bottom-line">{{ _._( 'text_user_status_title' ) }}</h4>
					<blockquote class = "fw-300 note">{{ _._( 'text_user_status_description' ) }}</blockquote>
