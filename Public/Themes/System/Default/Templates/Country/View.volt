	...
	<div class = "all-70 large-100 medium-100 small-100 tiny-100">
		<section class = "panel primary">
			...
			<section class = "panel-body clearfix">
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_iso_code_2' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ iso_code_2 }}
					</div>
				</div>
				...
				<div class = "control-group column-group validation">
					<label for = "" class = "medium-100 small-100 tiny-100 all-20 align-left"><b>{{ _._( 'field_iso_code_3' ) }}</b></label>
					<div class = "control medium-100 small-100 tiny-100 all-80">
						{{ iso_code_3 }}
					</div>
				</div>
